      ...
      <div className="container mx-auto flex justify-between items-start p-[20px]">
        ...
        <div className="w-1/2 pr-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <Image src="/frame1.png"alt="Nike Dri-FIT ADV TechKnit Ultra" width={300} height={300} />
            ...
            {/* Men's Item 2 */}
            <div className="text-center">
              <Image src= "/gear1.png" alt="Nike Dri-FIT Challenger" width={300} height={300} />
              <div className="flex justify-between items-center w-[300px]">
        ...
        <div className="w-1/2 pl-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <Image className="mt-[30px]" src="/gear2.png" alt="Nike Dri-FIT ADV Run Division" width={300} height={300} />
              <div className="flex justify-between items-center w-[300px]">
            ...
            <div className="text-center">
              <Image className="mt-[30px]" src="/gear3.png" alt="Nike Fast" width={300} height={300} />
              <div className="flex justify-between items-center w-[300px]">
